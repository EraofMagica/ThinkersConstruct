...
import dev.tocraft.thconstruct.library.client.book.TinkerBook;
import dev.tocraft.thconstruct.library.client.data.spritetransformer.GreyToColorMapping;
import dev.tocraft.thconstruct.library.client.data.spritetransformer.GreyToSpriteTransformer;
import dev.tocraft.thconstruct.library.client.data.spritetransformer.IColorMapping;
import dev.tocraft.thconstruct.library.client.data.spritetransformer.ISpriteTransformer;
import dev.tocraft.thconstruct.library.client.data.spritetransformer.RecolorSpriteTransformer;
import dev.tocraft.thconstruct.library.client.materials.MaterialRenderInfoLoader;
import dev.tocraft.thconstruct.library.client.model.TinkerTransformTypes;
import dev.tocraft.thconstruct.library.client.modifiers.ModifierIconManager;
import dev.tocraft.thconstruct.tables.client.PatternGuiTextureLoader;
 ...
 */
@EventBusSubscriber(modid = dev.tocraft.thconstruct.ThConstruct.MOD_ID, value = Dist.CLIENT, bus = Bus.FORGE)
