package dev.tocraft.thconstruct.shared.item;
...
public class CheeseItem extends Item {
  public static final Component TOOLTIP = dev.tocraft.thconstruct.ThConstruct.makeTranslation("item", "cheese.tooltip");
