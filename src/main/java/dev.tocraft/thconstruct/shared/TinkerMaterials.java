...
import dev.tocraft.thconstruct.shared.block.OrientableBlock;
import dev.tocraft.thconstruct.shared.block.SlimesteelBlock;
...
public final class TinkerMaterials extends TinkerModule {
  ...
  public static final FenceBuildingBlockObject nahuatl = BLOCKS.registerFenceBuilding("nahuatl", builder(NoteBlockInstrument.BASS, MapColor.PODZOL, SoundType.WOOD).requiresCorrectToolForDrops().strength(25f, 300f), GENERAL_BLOCK_ITEM);
