...
public class ModifierPriorityCommand {
  private static final Component SUCCESS = Component.translatable("command.thconstruct.modifier_priority");
  ...
  private static int run(CommandContext<CommandSourceStack> context, boolean filtered) {
    ...
    table.build(builder);
    dev.tocraft.thconstruct.ThConstruct.LOG.info(builder.toString());
