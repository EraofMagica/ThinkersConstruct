...
public class SlotsCommand {
  private static final String ADD_SUCCESS = dev.tocraft.thconstruct.ThConstruct.makeTranslationKey("command", "slots.success.add.single");
  private static final String ADD_SUCCESS_MULTIPLE = dev.tocraft.thconstruct.ThConstruct.makeTranslationKey("command", "slots.success.add.multiple");
  private static final String SET_SUCCESS = dev.tocraft.thconstruct.ThConstruct.makeTranslationKey("command", "slots.success.set.single");
  private static final String SET_SUCCESS_MULTIPLE = dev.tocraft.thconstruct.ThConstruct.makeTranslationKey("command", "slots.success.set.multiple");
  private static final SimpleCommandExceptionType INVALID_SLOT_COUNT = new SimpleCommandExceptionType(dev.tocraft.thconstruct.ThConstruct.makeTranslation("command", "slots.failure.invalid_count"));
