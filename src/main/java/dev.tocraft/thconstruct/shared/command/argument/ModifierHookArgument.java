...
public class ModifierHookArgument implements ArgumentType<ModuleHook<?>> {
  private static final Collection<String> EXAMPLES = Arrays.asList("thconstruct:tool_stats", "thconstruct:tooltip");
  private static final DynamicCommandExceptionType HOOK_NOT_FOUND = new DynamicCommandExceptionType(name -> dev.tocraft.thconstruct.ThConstruct.makeTranslation("command", "modifier_hook.not_found", name));
