...
public class MaterialArgument implements ArgumentType<IMaterial> {
  private static final Collection<String> EXAMPLES = Arrays.asList("thconstruct:wood", "thconstruct:iron");
  private static final DynamicCommandExceptionType NOT_FOUND = new DynamicCommandExceptionType(name -> dev.tocraft.thconstruct.ThConstruct.makeTranslation("command", "material.not_found", name));
