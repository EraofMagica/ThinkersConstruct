...
public class SlotTypeArgument implements ArgumentType<OptionalSlotType> {
  ...
  private static final DynamicCommandExceptionType SLOT_TYPE_NOT_FOUND = new DynamicCommandExceptionType(name -> Component.translatable("command.thconstruct.slot_type.not_found", name));
