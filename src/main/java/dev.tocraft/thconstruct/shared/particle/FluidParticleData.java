package dev.tocraft.thconstruct.shared.particle;
...
public class FluidParticleData implements ParticleOptions {
  private static final DynamicCommandExceptionType UNKNOWN_FLUID = new DynamicCommandExceptionType(arg -> Component.translatable("command.thconstruct.fluid.not_found", arg));
