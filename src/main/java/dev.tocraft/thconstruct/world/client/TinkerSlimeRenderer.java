...
public class TinkerSlimeRenderer extends SlimeRenderer {
  public static final Factory SKY_SLIME_FACTORY = new Factory(dev.tocraft.thconstruct.ThConstruct.getResource("textures/entity/sky_slime.png"));
  public static final Factory ENDER_SLIME_FACTORY = new Factory(dev.tocraft.thconstruct.ThConstruct.getResource("textures/entity/ender_slime.png"));
