package dev.tocraft.thconstruct.world;
...
import dev.tocraft.thconstruct.world.block.SlimeVineBlock;
import dev.tocraft.thconstruct.world.block.SlimeVineBlock.VineStage;
import dev.tocraft.thconstruct.world.data.StructureRepalleter;
import dev.tocraft.thconstruct.world.data.WorldgenDatapackRegistryProvider;
import dev.tocraft.thconstruct.world.worldgen.islands.IslandPiece;
import dev.tocraft.thconstruct.world.worldgen.islands.IslandStructure;
import dev.tocraft.thconstruct.world.worldgen.trees.ExtraRootVariantPlacer;
import dev.tocraft.thconstruct.world.worldgen.trees.LeaveVineDecorator;
import dev.tocraft.thconstruct.world.worldgen.trees.SupplierBlockStateProvider;
import dev.tocraft.thconstruct.world.worldgen.trees.config.SlimeFungusConfig;
import dev.tocraft.thconstruct.world.worldgen.trees.config.SlimeTreeConfig;
import dev.tocraft.thconstruct.world.worldgen.trees.feature.SlimeFungusFeature;
import dev.tocraft.thconstruct.world.worldgen.trees.feature.SlimeTreeFeature;
...
public final class TinkerStructures extends TinkerModule {
  ...
  private static final DeferredRegister<Feature<?>> FEATURES = DeferredRegister.create(ForgeRegistries.FEATURES, dev.tocraft.thconstruct.ThConstruct.MOD_ID);
    private static final DeferredRegister<StructureType<?>> STRUCTURE_TYPE = DeferredRegister.create(Registry.STRUCTURE_TYPE_REGISTRY, dev.tocraft.thconstruct.ThConstruct.MOD_ID);
  private static final DeferredRegister<StructurePieceType> STRUCTURE_PIECE = DeferredRegister.create(Registry.STRUCTURE_PIECE_REGISTRY, dev.tocraft.thconstruct.ThConstruct.MOD_ID);
  private static final DeferredRegister<BlockStateProviderType<?>> BLOCK_STATE_PROVIDER_TYPES = DeferredRegister.create(ForgeRegistries.BLOCK_STATE_PROVIDER_TYPES, dev.tocraft.thconstruct.ThConstruct.MOD_ID);
  private static final DeferredRegister<TreeDecoratorType<?>> TREE_DECORATORS = DeferredRegister.create(Registry.TREE_DECORATOR_TYPE_REGISTRY, dev.tocraft.thconstruct.ThConstruct.MOD_ID);
  private static final DeferredRegister<RootPlacerType<?>> ROOT_PLACERS = DeferredRegister.create(Registry.ROOT_PLACER_TYPE_REGISTRY, dev.tocraft.thconstruct.ThConstruct.MOD_ID);
