...
public class GuiMeltingModule {
  ...
  private static final Component TOOLTIP_NO_HEAT = Component.translatable(dev.tocraft.thconstruct.ThConstruct.makeTranslationKey("gui", "melting.no_heat"));
  private static final Component TOOLTIP_NO_SPACE = Component.translatable(dev.tocraft.thconstruct.ThConstruct.makeTranslationKey("gui", "melting.no_space"));
  private static final Component TOOLTIP_UNMELTABLE = Component.translatable(dev.tocraft.thconstruct.ThConstruct.makeTranslationKey("gui", "melting.no_recipe"));
