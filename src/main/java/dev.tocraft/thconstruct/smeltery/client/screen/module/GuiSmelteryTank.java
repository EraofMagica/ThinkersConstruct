...
public class GuiSmelteryTank {
  // fluid tooltips
  public static final Component TOOLTIP_CAPACITY = dev.tocraft.thconstruct.ThConstruct.makeTranslation("gui", "melting.capacity");
  public static final Component TOOLTIP_AVAILABLE = dev.tocraft.thconstruct.ThConstruct.makeTranslation("gui", "melting.available");
  public static final Component TOOLTIP_USED = dev.tocraft.thconstruct.ThConstruct.makeTranslation("gui", "melting.used");
