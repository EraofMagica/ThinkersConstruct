...
import dev.tocraft.thconstruct.smeltery.client.screen.module.GuiTankModule;
...
public class MelterScreen extends AbstractContainerScreen<MelterContainerMenu> implements IScreenWithFluidTank {
  private static final ResourceLocation BACKGROUND = dev.tocraft.thconstruct.ThConstruct.getResource("textures/gui/melter.png");
