...
import dev.tocraft.thconstruct.smeltery.block.entity.module.FuelModule;
import dev.tocraft.thconstruct.smeltery.block.entity.module.FuelModule.FuelInfo;
...
public class GuiFuelModule {
  ...
  // tooltips
  private static final String TOOLTIP_TEMPERATURE = dev.tocraft.thconstruct.ThConstruct.makeTranslationKey("gui", "melting.fuel.temperature");
  private static final List<Component> TOOLTIP_NO_TANK = Collections.singletonList(Component.translatable(dev.tocraft.thconstruct.ThConstruct.makeTranslationKey("gui", "melting.fuel.no_tank")));
  private static final List<Component> TOOLTIP_NO_FUEL = Collections.singletonList(Component.translatable(dev.tocraft.thconstruct.ThConstruct.makeTranslationKey("gui", "melting.fuel.empty")));
  private static final Component TOOLTIP_INVALID_FUEL = Component.translatable(dev.tocraft.thconstruct.ThConstruct.makeTranslationKey("gui", "melting.fuel.invalid")).withStyle(ChatFormatting.RED);
  private static final Component TOOLTIP_SOLID_FUEL = Component.translatable(dev.tocraft.thconstruct.ThConstruct.makeTranslationKey("gui", "melting.fuel.solid"));
