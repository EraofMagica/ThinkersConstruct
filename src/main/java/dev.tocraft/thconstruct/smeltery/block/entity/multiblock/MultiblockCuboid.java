...
import dev.tocraft.thconstruct.library.utils.TagUtil;
...
public abstract class MultiblockCuboid<T extends MultiblockStructureData> {
  ...
  protected static final MultiblockResult NO_ATTEMPT = MultiblockResult.error(null, dev.tocraft.thconstruct.ThConstruct.makeTranslation("multiblock", "generic.no_attempt"));
  /** Error if the structure is outside the loaded area */
  protected static final MultiblockResult NOT_LOADED = MultiblockResult.error(null, dev.tocraft.thconstruct.ThConstruct.makeTranslation("multiblock", "generic.not_loaded"));
  /** Error if the structure is outside the loaded area */
  protected static final MultiblockResult TOO_HIGH = MultiblockResult.error(null, dev.tocraft.thconstruct.ThConstruct.makeTranslation("multiblock", "generic.too_high"));

  /** Error if the structure inside is not valid */
  protected static final Component INVALID_INNER_BLOCK = dev.tocraft.thconstruct.ThConstruct.makeTranslation("multiblock", "generic.invalid_inner_block");
  /** Error if the structure inside is not valid */
  protected static final String TOO_LARGE = dev.tocraft.thconstruct.ThConstruct.makeTranslationKey("multiblock", "generic.too_large");
  /** Error if a block is invalid in the floor */
  protected static final Component INVALID_FLOOR_BLOCK = dev.tocraft.thconstruct.ThConstruct.makeTranslation("multiblock", "generic.invalid_floor_block");
  /** Error if a block is invalid in the ceiling */
  protected static final Component INVALID_CEILING_BLOCK = dev.tocraft.thconstruct.ThConstruct.makeTranslation("multiblock", "generic.invalid_floor_block");
  /** Error if a block is invalid in the walls */
  protected static final Component INVALID_WALL_BLOCK = dev.tocraft.thconstruct.ThConstruct.makeTranslation("multiblock", "generic.invalid_wall_block");
  /** Error if the structure floor has no frame */
  protected static final Component INVALID_FLOOR_FRAME = dev.tocraft.thconstruct.ThConstruct.makeTranslation("multiblock", "generic.invalid_floor_frame");
  /** Error if the structure ceiling has no frame */
  protected static final Component INVALID_CEILING_FRAME = dev.tocraft.thconstruct.ThConstruct.makeTranslation("multiblock", "generic.invalid_ceiling_frame");
  /** Error if the structure wall has no frame */
  protected static final Component INVALID_WALL_FRAME = dev.tocraft.thconstruct.ThConstruct.makeTranslation("multiblock", "generic.invalid_wall_frame");
