...
import dev.tocraft.thconstruct.smeltery.block.entity.module.ByproductMeltingModuleInventory;
import dev.tocraft.thconstruct.smeltery.block.entity.module.MeltingModuleInventory;
import dev.tocraft.thconstruct.smeltery.block.entity.multiblock.FoundryMultiblock;
...
public class FoundryBlockEntity extends HeatingStructureBlockEntity {
  ...
  /** GUI name */
  private static final Component NAME = dev.tocraft.thconstruct.ThConstruct.makeTranslation("gui", "foundry");
