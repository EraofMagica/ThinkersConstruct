...
import dev.tocraft.thconstruct.smeltery.block.entity.module.alloying.MultiAlloyingModule;
import dev.tocraft.thconstruct.smeltery.block.entity.module.alloying.SmelteryAlloyTank;
...
import dev.tocraft.thconstruct.smeltery.block.entity.multiblock.SmelteryMultiblock;
...
public class SmelteryBlockEntity extends HeatingStructureBlockEntity {
  ...
  /** Name of the UI */
  private static final Component NAME = dev.tocraft.thconstruct.ThConstruct.makeTranslation("gui", "smeltery");
