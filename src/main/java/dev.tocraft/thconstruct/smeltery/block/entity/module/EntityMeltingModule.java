...
import dev.tocraft.thconstruct.common.TinkerTags.EntityTypes;
...
public class EntityMeltingModule {
  ...
  public static final DamageSource SMELTERY_DAMAGE = new DamageSource(dev.tocraft.thconstruct.ThConstruct.prefix("smeltery_heat")).setIsFire();
  /** Special damage source for "absorbing" hot entities */
  public static final DamageSource SMELTERY_MAGIC = new DamageSource(dev.tocraft.thconstruct.ThConstruct.prefix("smeltery_magic")).setMagic();
