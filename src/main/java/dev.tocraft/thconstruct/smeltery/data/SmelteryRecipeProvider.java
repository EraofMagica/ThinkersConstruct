...
import dev.tocraft.eomantle.recipe.crafting.ShapedRetexturedRecipeBuilder;
import dev.tocraft.eomantle.recipe.data.ConsumerWrapperBuilder;
import dev.tocraft.eomantle.recipe.data.ICommonRecipeHelper;
import dev.tocraft.eomantle.recipe.data.ItemNameIngredient;
import dev.tocraft.eomantle.recipe.data.ItemNameOutput;
import dev.tocraft.eomantle.recipe.data.NBTNameIngredient;
...
import dev.tocraft.thconstruct.library.data.recipe.ISmelteryRecipeHelper;
import dev.tocraft.thconstruct.library.recipe.FluidValues;
import dev.tocraft.thconstruct.library.recipe.alloying.AlloyRecipeBuilder;
import dev.tocraft.thconstruct.library.recipe.casting.ItemCastingRecipeBuilder;
import dev.tocraft.thconstruct.library.recipe.casting.PotionCastingRecipeBuilder;
import dev.tocraft.thconstruct.library.recipe.casting.container.ContainerFillingRecipeBuilder;
import dev.tocraft.thconstruct.library.recipe.entitymelting.EntityMeltingRecipeBuilder;
import dev.tocraft.thconstruct.library.recipe.fuel.MeltingFuelBuilder;
...
import dev.tocraft.thconstruct.library.recipe.melting.MeltingRecipeBuilder;
