package dev.tocraft.thconstruct.plugin.jei.partbuilder;
...
public class PartBuilderCategory implements IRecipeCategory<IDisplayPartBuilderRecipe> {
  private static final ResourceLocation BACKGROUND_LOC = dev.tocraft.thconstruct.ThConstruct.getResource("textures/gui/jei/tinker_station.png");
  private static final Component TITLE = dev.tocraft.thconstruct.ThConstruct.makeTranslation("jei", "part_builder.title");
  private static final String KEY_COST = dev.tocraft.thconstruct.ThConstruct.makeTranslationKey("jei", "part_builder.cost");
