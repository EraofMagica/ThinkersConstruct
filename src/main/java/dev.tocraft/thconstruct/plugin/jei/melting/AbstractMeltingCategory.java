...
import dev.tocraft.thconstruct.plugin.jei.IRecipeTooltipReplacement;
...
public abstract class AbstractMeltingCategory implements IRecipeCategory<MeltingRecipe> {
  protected static final ResourceLocation BACKGROUND_LOC = dev.tocraft.thconstruct.ThConstruct.getResource("textures/gui/jei/melting.png");
  protected static final String KEY_COOLING_TIME = dev.tocraft.thconstruct.ThConstruct.makeTranslationKey("jei", "melting.time");
  protected static final String KEY_TEMPERATURE = dev.tocraft.thconstruct.ThConstruct.makeTranslationKey("jei", "temperature");
  protected static final String KEY_MULTIPLIER = dev.tocraft.thconstruct.ThConstruct.makeTranslationKey("jei", "melting.multiplier");
  protected static final Component TOOLTIP_ORE = Component.translatable(dev.tocraft.thconstruct.ThConstruct.makeTranslationKey("jei", "melting.ore"));
