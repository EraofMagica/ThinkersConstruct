package dev.tocraft.thconstruct.plugin.jei.melting;
...
public class MeltingCategory extends AbstractMeltingCategory {
  private static final Component TITLE = dev.tocraft.thconstruct.ThConstruct.makeTranslation("jei", "melting.title");
  private static final String KEY_TEMPERATURE = dev.tocraft.thconstruct.ThConstruct.makeTranslationKey("jei", "temperature");
  private static final String KEY_MULTIPLIER = dev.tocraft.thconstruct.ThConstruct.makeTranslationKey("jei", "melting.multiplier");
  ...
  private static final Component TOOLTIP_SMELTERY = dev.tocraft.thconstruct.ThConstruct.makeTranslation("jei", "melting.smeltery").withStyle(ChatFormatting.GRAY, ChatFormatting.UNDERLINE);
  private static final Component TOOLTIP_MELTER = dev.tocraft.thconstruct.ThConstruct.makeTranslation("jei", "melting.melter").withStyle(ChatFormatting.GRAY, ChatFormatting.UNDERLINE);
