...
import dev.tocraft.thconstruct.plugin.jei.AlloyRecipeCategory;
...
public class FoundryCategory extends AbstractMeltingCategory {
  private static final Component TITLE = dev.tocraft.thconstruct.ThConstruct.makeTranslation("jei", "foundry.title");
