...
public abstract class AbstractCastingCategory implements IRecipeCategory<IDisplayableCastingRecipe>, IRecipeTooltipReplacement {
  private static final String KEY_COOLING_TIME = dev.tocraft.thconstruct.ThConstruct.makeTranslationKey("jei", "time");
  private static final String KEY_CAST_KEPT = dev.tocraft.thconstruct.ThConstruct.makeTranslationKey("jei", "casting.cast_kept");
  private static final String KEY_CAST_CONSUMED = dev.tocraft.thconstruct.ThConstruct.makeTranslationKey("jei", "casting.cast_consumed");
  protected static final ResourceLocation BACKGROUND_LOC = dev.tocraft.thconstruct.ThConstruct.getResource("textures/gui/jei/casting.png");
