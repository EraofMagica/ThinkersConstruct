package dev.tocraft.thconstruct.common.registration;
...
import dev.tocraft.eomantle.registration.deferred.BlockDeferredRegister;
import dev.tocraft.eomantle.registration.object.EnumObject;
import dev.tocraft.eomantle.registration.object.EnumObject.Builder;
...
public class BlockDeferredRegisterExtension extends BlockDeferredRegister {
  private static final BlockBehaviour.Properties POTTED_PROPS = BlockBehaviour.Properties.of().instabreak().noOcclusion();
