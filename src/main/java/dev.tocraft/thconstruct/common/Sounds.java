...
@Mod.EventBusSubscriber(modid = dev.tocraft.thconstruct.ThConstruct.MOD_ID, bus = Mod.EventBusSubscriber.Bus.MOD)
public enum Sounds {
  // blocks
  SAW("little_saw"),
  ITEM_FRAME_CLICK,
  ...
  Sounds(String name) {
    ResourceLocation registryName = dev.tocraft.thconstruct.ThConstruct.getResource(name);
