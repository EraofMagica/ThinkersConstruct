package dev.tocraft.thconstruct.common.config;
...
import dev.tocraft.thconstruct.library.recipe.melting.IMeltingContainer.OreRateType;
import dev.tocraft.thconstruct.library.utils.Orientation2D;
  ...
  public static class Common {
    ...
    Common(ForgeConfigSpec.Builder builder) {
      ...
      this.shouldSpawnWithTinkersBook = builder
        ...
        .translation("thconstruct.configgui.shouldSpawnWithTinkersBook")
        .worldRestart()
      ...
      actions.add(new ConfigurableAction(builder, "wither", true, "Makes withering damage count as magic", DamageTypes.WITHER::setMagic));
      actions.add(new ConfigurableAction(builder, "dragon_breath", true, "Makes dragons breath count as magic", DamageTypes.DRAGON_BREATH::setMagic));
      actions.add(new ConfigurableAction(builder, "falling_block", false, "Makes falling blocks count as projectile", () -> {
        DamageTypes.FALLING_BLOCK.setProjectile();
        DamageTypes.FALLING_ANVIL.setProjectile();
        DamageTypes.FALLING_STALACTITE.setProjectile();
      }));
      actions.add(new ConfigurableAction(builder, "lightning", true, "Makes lightning count as fire damage", DamageTypes.LIGHTNING_BOLT::setIsFire));
...
//        .translation("thconstruct.configgui.chestsKeepInventory")
//        .worldRestart()
//        .define("chestsKeepInventory", true);
      ...
      this.showOnlyToolMaterial = builder
        ...
        .translation("thconstruct.configgui.showOnlyToolMaterial")
        .worldRestart()
      ...
      this.showOnlyPartMaterial = builder
        ...
        .translation("thconstruct.configgui.showOnlyPartMaterial")
        .worldRestart()
      ...
      this.showAllTableVariants = builder
        ...
        .translation("thconstruct.configgui.showAllTableVariants")
      ...
      this.showAllAnvilVariants = builder
        ...
        .translation("thconstruct.configgui.showAllAnvilVariants")
      ...
      this.showAllSmelteryVariants = builder
        ...
        .translation("thconstruct.configgui.showAllSmelteryVariants")
      ...
      this.addGravelToFlintRecipe = builder
        ...
        .translation("thconstruct.configgui.addGravelToFlintRecipe")
        .worldRestart()
      ...
      this.glassRecipeFix = builder
        ...
        .translation("thconstruct.configgui.glassRecipeFix")
        .worldRestart()
      ...
      for (TinkerHeadType headType : TinkerHeadType.values()) {
        headDrops.put(headType, builder
          .translation("thconstruct.configgui.heads." + headType.getSerializedName())
  ...
  /**
   * Client specific configuration - only loaded clientside from thconstruct-client.toml
   */
...
//        .translation("thconstruct.configgui.temperatureInCelsius")
//        .define("temperatureInCelsius", true);
      ...
      this.logMissingMaterialTextures = builder
        ...
        .translation("thconstruct.configgui.logMissingMaterialTextures")
      ...
      this.showModifiersInJEI = builder
        ...
        .translation("thconstruct.configgui.showModifiersInJEI")
