...
public class TinkerTags {
  ...
  public static class Blocks {
    ...
    public static TagKey<Block> tag(String name) {
      return TagKey.create(Registry.BLOCK_REGISTRY, dev.tocraft.thconstruct.ThConstruct.getResource(name));
    }
  ...
  public static class Items {
    ...
    /** Tools that can adjust the loot context for {@link Modifier#processLoot(IToolStackView, dev.tocraft.thconstruct.library.modifiers.ModifierEntry, List, LootContext)} */
    ...
    private static TagKey<Item> tag(String name) {
      return TagKey.create(Registry.ITEM_REGISTRY, dev.tocraft.thconstruct.ThConstruct.getResource(name));
    }
  ...
  public static class Fluids {
    ...
    private static TagKey<Fluid> tag(String name) {
      return TagKey.create(Registry.FLUID_REGISTRY, dev.tocraft.thconstruct.ThConstruct.getResource(name));
    }
  }
  ...
  public static class EntityTypes {
    ...
    private static TagKey<EntityType<?>> tag(String name) {
      return TagKey.create(Registry.ENTITY_TYPE_REGISTRY, dev.tocraft.thconstruct.ThConstruct.getResource(name));
    }
  ...
  public static class TileEntityTypes {
    ...
    private static TagKey<BlockEntityType<?>> tag(String name) {
      return TagKey.create(Registry.BLOCK_ENTITY_TYPE_REGISTRY, dev.tocraft.thconstruct.ThConstruct.getResource(name));
    }
  }
  ...
  public static class Biomes {
    ...
    private static TagKey<Biome> tag(String name) {
      return TagKey.create(Registry.BIOME_REGISTRY, dev.tocraft.thconstruct.ThConstruct.getResource(name));
    }
  }
  ...
  public static class Modifiers {
    ...
    private static TagKey<Modifier> tag(String name) {
      return ModifierManager.getTag(dev.tocraft.thconstruct.ThConstruct.getResource(name));
    }
  }
  ...
  public static class Materials {
    ...
    private static TagKey<IMaterial> tag(String name) {
      return MaterialManager.getTag(dev.tocraft.thconstruct.ThConstruct.getResource(name));
    }
  }
}
