package dev.tocraft.thconstruct.gadgets.client;
...
public class FancyItemFrameRenderer<T extends FancyItemFrameEntity> extends ItemFrameRenderer<T> {
  ...
  static {
    for (FrameType type : FrameType.values()) {
      ...
      LOCATIONS_MODEL.put(type, dev.tocraft.thconstruct.ThConstruct.getResource("block/frame/" + name));
      LOCATIONS_MODEL_MAP.put(type, dev.tocraft.thconstruct.ThConstruct.getResource("block/frame/" + name + "_map"));
    }
  }
