...
import dev.tocraft.thconstruct.library.data.tinkering.AbstractModifierProvider;
...
import dev.tocraft.thconstruct.library.json.variable.melee.EntityMeleeVariable.WhichEntity;
...
import dev.tocraft.thconstruct.library.modifiers.modules.technical.ArmorStatModule.TooltipStyle;
...
import dev.tocraft.thconstruct.tools.logic.ModifierEvents;
...
import static dev.tocraft.thconstruct.library.json.math.ModifierFormula.MULTIPLIER;
import static dev.tocraft.thconstruct.library.json.math.ModifierFormula.VALUE;
import static dev.tocraft.thconstruct.library.modifiers.modules.behavior.RepairModule.FACTOR;
import static dev.tocraft.thconstruct.library.tools.definition.ModifiableArmorMaterial.ARMOR_SLOTS;
...
public class ModifierProvider extends AbstractModifierProvider implements IConditionBuilder {
  ...
  private static ModifierId id(String name) {
    return new ModifierId(dev.tocraft.thconstruct.ThConstruct.MOD_ID, name);
  }
}
