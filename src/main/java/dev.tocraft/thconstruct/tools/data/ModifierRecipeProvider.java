...
import dev.tocraft.eomantle.recipe.data.ItemNameIngredient;
...
import dev.tocraft.thconstruct.common.registration.GeodeItemObject.BudSize;
...
import dev.tocraft.thconstruct.library.recipe.ingredient.MaterialIngredient;
...
import dev.tocraft.thconstruct.library.recipe.modifiers.adding.IncrementalModifierRecipeBuilder;
import dev.tocraft.thconstruct.library.recipe.modifiers.adding.ModifierRecipeBuilder;
import dev.tocraft.thconstruct.library.recipe.modifiers.adding.MultilevelModifierRecipeBuilder;
import dev.tocraft.thconstruct.library.recipe.modifiers.adding.OverslimeModifierRecipeBuilder;
import dev.tocraft.thconstruct.library.recipe.modifiers.adding.SwappableModifierRecipe.VariantFormatter;
import dev.tocraft.thconstruct.library.recipe.modifiers.adding.SwappableModifierRecipeBuilder;
import dev.tocraft.thconstruct.library.recipe.modifiers.severing.SeveringRecipeBuilder;
import dev.tocraft.thconstruct.library.recipe.tinkerstation.repairing.ModifierMaterialRepairRecipeBuilder;
import dev.tocraft.thconstruct.library.recipe.tinkerstation.repairing.ModifierRepairRecipeBuilder;
import dev.tocraft.thconstruct.library.recipe.worktable.ModifierSetWorktableRecipeBuilder;
...
import dev.tocraft.thconstruct.tools.recipe.EnchantmentConvertingRecipeBuilder;
import dev.tocraft.thconstruct.tools.recipe.ModifierRemovalRecipeBuilder;
import dev.tocraft.thconstruct.tools.recipe.ModifierSortingRecipeBuilder;
...
public class ModifierRecipeProvider extends BaseRecipeProvider {
  ...
  private void addModifierRecipes(Consumer<FinishedRecipe> consumer) {
    ...
    // invisible ink
    ResourceLocation hiddenModifiers = dev.tocraft.thconstruct.ThConstruct.getResource("invisible_modifiers");
