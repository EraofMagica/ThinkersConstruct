...
import dev.tocraft.thconstruct.library.data.tinkering.AbstractEnchantmentToModifierProvider;
...
public class EnchantmentToModifierProvider extends AbstractEnchantmentToModifierProvider {
  ...
  private void addCompat(ModifierId modifier) {
    add(dev.tocraft.thconstruct.ThConstruct.getResource("modifier_like/" + modifier.getPath()), modifier);
  }
