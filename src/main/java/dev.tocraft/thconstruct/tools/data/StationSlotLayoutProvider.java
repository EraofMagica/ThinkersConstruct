...
import dev.tocraft.thconstruct.library.data.tinkering.AbstractStationSlotLayoutProvider;
import dev.tocraft.thconstruct.library.tools.layout.Patterns;
...
public class StationSlotLayoutProvider extends AbstractStationSlotLayoutProvider {
  ...
  protected void addLayouts() {
    ...
    define(TinkerTables.tinkerStation)
      .translationKey(dev.tocraft.thconstruct.ThConstruct.makeTranslationKey("gui", "tinker_station.repair_limited"))
    ...
    Consumer<ItemLike> addAnvil = item ->
      define(item)
        .translationKey(dev.tocraft.thconstruct.ThConstruct.makeTranslationKey("gui", "tinker_station.repair"))
        .icon(Patterns.REPAIR)
    ...
    define(dev.tocraft.thconstruct.ThConstruct.getResource("plate_armor"))
      .sortIndex(SORT_ARMOR)
      .translationKey(dev.tocraft.thconstruct.ThConstruct.makeTranslationKey("gui", "plate_armor"))
