...
import static dev.tocraft.thconstruct.library.materials.definition.MaterialVariantId.create;
...
public final class MaterialIds {
  ...
  private static MaterialId id(String name) {
    return new MaterialId(dev.tocraft.thconstruct.ThConstruct.MOD_ID, name);
  }
}
