package dev.tocraft.thconstruct.tools.data.material;

import net.minecraft.data.DataGenerator;
import dev.tocraft.thconstruct.library.data.material.AbstractMaterialDataProvider;
import dev.tocraft.thconstruct.library.data.material.AbstractMaterialTraitDataProvider;
...
import static dev.tocraft.thconstruct.library.materials.MaterialRegistry.ARMOR;
import static dev.tocraft.thconstruct.library.materials.MaterialRegistry.MELEE_HARVEST;
import static dev.tocraft.thconstruct.library.materials.MaterialRegistry.RANGED;
