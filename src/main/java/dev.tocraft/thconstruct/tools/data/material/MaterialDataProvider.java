...
public class MaterialDataProvider extends AbstractMaterialDataProvider {
  ...
  protected void addMaterials() {
    ...
    addRedirect(new MaterialId(dev.tocraft.thconstruct.ThConstruct.MOD_ID, "bloodbone"), redirect(MaterialIds.venombone));
    ...
    addRedirect(new MaterialId(dev.tocraft.thconstruct.ThConstruct.MOD_ID, "chain"), redirect(MaterialIds.roseGold));
  }
}
