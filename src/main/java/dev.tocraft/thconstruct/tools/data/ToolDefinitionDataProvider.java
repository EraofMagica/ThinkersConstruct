...
import dev.tocraft.thconstruct.library.data.tinkering.AbstractToolDefinitionDataProvider;
...
import dev.tocraft.thconstruct.library.tools.definition.module.aoe.IBoxExpansion;
...
import dev.tocraft.thconstruct.tools.TinkerToolActions;
import dev.tocraft.thconstruct.tools.TinkerToolParts;
import dev.tocraft.thconstruct.tools.TinkerTools;
import dev.tocraft.thconstruct.tools.ToolDefinitions;
...
import static dev.tocraft.thconstruct.tools.TinkerToolParts.bowGrip;
import static dev.tocraft.thconstruct.tools.TinkerToolParts.bowLimb;
import static dev.tocraft.thconstruct.tools.TinkerToolParts.bowstring;
import static dev.tocraft.thconstruct.tools.TinkerToolParts.broadAxeHead;
import static dev.tocraft.thconstruct.tools.TinkerToolParts.broadBlade;
import static dev.tocraft.thconstruct.tools.TinkerToolParts.hammerHead;
import static dev.tocraft.thconstruct.tools.TinkerToolParts.largePlate;
import static dev.tocraft.thconstruct.tools.TinkerToolParts.pickHead;
import static dev.tocraft.thconstruct.tools.TinkerToolParts.roundPlate;
import static dev.tocraft.thconstruct.tools.TinkerToolParts.smallAxeHead;
import static dev.tocraft.thconstruct.tools.TinkerToolParts.smallBlade;
import static dev.tocraft.thconstruct.tools.TinkerToolParts.toolBinding;
import static dev.tocraft.thconstruct.tools.TinkerToolParts.toolHandle;
import static dev.tocraft.thconstruct.tools.TinkerToolParts.toughHandle;
