...
import dev.tocraft.thconstruct.tools.modifiers.defense.BlastProtectionModifier.BlastData;
...
public class BlastProtectionModifier extends AbstractProtectionModifier<BlastData> {
  ...
  private static final ComputableDataKey<BlastData> BLAST_DATA = dev.tocraft.thconstruct.ThConstruct.createKey("blast_protection", BlastData::new);
