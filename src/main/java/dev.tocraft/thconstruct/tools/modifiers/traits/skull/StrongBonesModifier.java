...
import dev.tocraft.thconstruct.library.modifiers.modules.technical.CureOnRemovalModule;
...
public class StrongBonesModifier extends NoLevelsModifier {
  ...
  public static final TinkerDataKey<Integer> CALCIFIABLE = dev.tocraft.thconstruct.ThConstruct.createKey("calcifable");
