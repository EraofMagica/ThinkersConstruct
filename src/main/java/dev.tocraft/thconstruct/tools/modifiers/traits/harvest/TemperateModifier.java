...
import static dev.tocraft.thconstruct.library.modifiers.modules.behavior.ReduceToolDamageModule.reduceDamage;
...
public class TemperateModifier extends Modifier implements ConditionalStatModifierHook, ToolDamageModifierHook, BreakSpeedModifierHook, TooltipModifierHook, ProtectionModifierHook {
  ...
  private static final Component SPEED = dev.tocraft.thconstruct.ThConstruct.makeTranslation("modifier", "temperate.speed");
  private static final Component REINFORCED = dev.tocraft.thconstruct.ThConstruct.makeTranslation("modifier", "temperate.reinforced");
