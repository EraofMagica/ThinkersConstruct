...
public class DoubleJumpModifier extends Modifier {
  private static final ResourceLocation JUMPS = dev.tocraft.thconstruct.ThConstruct.getResource("jumps");
  private static final TinkerDataKey<Integer> EXTRA_JUMPS = dev.tocraft.thconstruct.ThConstruct.createKey("extra_jumps");
