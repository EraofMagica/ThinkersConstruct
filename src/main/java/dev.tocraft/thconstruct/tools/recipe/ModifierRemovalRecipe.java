...
import dev.tocraft.eomantle.data.loadable.common.ItemStackLoadable;
...
public class ModifierRemovalRecipe extends AbstractWorktableRecipe {
  public static final String BASE_KEY = dev.tocraft.thconstruct.ThConstruct.makeTranslationKey("recipe", "remove_modifier");
  private static final Component DESCRIPTION = dev.tocraft.thconstruct.ThConstruct.makeTranslation("recipe", "remove_modifier.description");
  private static final Component NO_MODIFIERS = dev.tocraft.thconstruct.ThConstruct.makeTranslation("recipe", "remove_modifier.no_modifiers");
