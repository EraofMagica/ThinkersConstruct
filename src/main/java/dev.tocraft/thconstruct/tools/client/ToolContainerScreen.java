...
import static dev.tocraft.thconstruct.tools.menu.ToolContainerMenu.REPEAT_BACKGROUND_START;
import static dev.tocraft.thconstruct.tools.menu.ToolContainerMenu.SLOT_SIZE;

/** Screen for a tool inventory */
public class ToolContainerScreen extends AbstractContainerScreen<ToolContainerMenu> {
  /** The ResourceLocation containing the chest GUI texture. */
  private static final ResourceLocation TEXTURE = dev.tocraft.thconstruct.ThConstruct.getResource("textures/gui/tool.png");
