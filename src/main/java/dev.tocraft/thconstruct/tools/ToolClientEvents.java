...
import dev.tocraft.eomantle.data.listener.ISafeManagerReloadListener;
...
import dev.tocraft.thconstruct.library.client.armor.AbstractArmorModel;
import dev.tocraft.thconstruct.library.client.armor.ArmorModelManager;
import dev.tocraft.thconstruct.library.client.materials.MaterialTooltipCache;
import dev.tocraft.thconstruct.library.client.model.DynamicTextureLoader;
import dev.tocraft.thconstruct.library.client.model.TinkerItemProperties;
import dev.tocraft.thconstruct.library.client.model.tools.MaterialModel;
import dev.tocraft.thconstruct.library.client.model.tools.ToolModel;
import dev.tocraft.thconstruct.library.client.modifiers.DyedModifierModel;
import dev.tocraft.thconstruct.library.client.modifiers.FluidModifierModel;
import dev.tocraft.thconstruct.library.client.modifiers.MaterialModifierModel;
import dev.tocraft.thconstruct.library.client.modifiers.ModifierModelManager;
import dev.tocraft.thconstruct.library.client.modifiers.ModifierModelManager.ModifierModelRegistrationEvent;
import dev.tocraft.thconstruct.library.client.modifiers.NormalModifierModel;
import dev.tocraft.thconstruct.library.client.modifiers.TankModifierModel;
import dev.tocraft.thconstruct.library.client.particle.AttackParticle;
...
import dev.tocraft.thconstruct.tools.client.CrystalshotRenderer;
import dev.tocraft.thconstruct.tools.client.FluidEffectProjectileRenderer;
import dev.tocraft.thconstruct.tools.client.OverslimeModifierModel;
import dev.tocraft.thconstruct.tools.client.SlimeskullArmorModel;
import dev.tocraft.thconstruct.tools.client.ToolContainerScreen;
import dev.tocraft.thconstruct.tools.item.ModifierCrystalItem;
import dev.tocraft.thconstruct.tools.logic.InteractionHandler;
...
import static dev.tocraft.thconstruct.library.client.model.tools.ToolModel.registerItemColors;
...
public class ToolClientEvents extends ClientEventBase {
  ...
  private static final KeyMapping HELMET_INTERACT = new KeyMapping(dev.tocraft.thconstruct.ThConstruct.makeTranslationKey("key", "helmet_interact"), KeyConflictContext.IN_GAME, InputConstants.getKey("key.keyboard.z"), "key.categories.thconstruct");
  /** Keybinding for interacting using leggings */
  private static final KeyMapping LEGGINGS_INTERACT = new KeyMapping(dev.tocraft.thconstruct.ThConstruct.makeTranslationKey("key", "leggings_interact"), KeyConflictContext.IN_GAME, InputConstants.getKey("key.keyboard.i"), "key.categories.thconstruct");
  ...
  static void registerModifierModels(ModifierModelRegistrationEvent event) {
    event.registerModel(dev.tocraft.thconstruct.ThConstruct.getResource("normal"), NormalModifierModel.UNBAKED_INSTANCE);
    event.registerModel(dev.tocraft.thconstruct.ThConstruct.getResource("overslime"), OverslimeModifierModel.UNBAKED_INSTANCE);
    event.registerModel(dev.tocraft.thconstruct.ThConstruct.getResource("fluid"), FluidModifierModel.UNBAKED_INSTANCE);
    event.registerModel(dev.tocraft.thconstruct.ThConstruct.getResource("tank"), TankModifierModel.UNBAKED_INSTANCE);
    event.registerModel(dev.tocraft.thconstruct.ThConstruct.getResource("material"), MaterialModifierModel.UNBAKED_INSTANCE);
    event.registerModel(dev.tocraft.thconstruct.ThConstruct.getResource("dyed"), DyedModifierModel.UNBAKED_INSTANCE);
  }
