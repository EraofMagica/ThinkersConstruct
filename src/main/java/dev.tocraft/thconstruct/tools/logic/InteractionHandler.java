package dev.tocraft.thconstruct.tools.logic;
 ...
 */
@EventBusSubscriber(modid = dev.tocraft.thconstruct.ThConstruct.MOD_ID, bus = Bus.FORGE)
public class InteractionHandler {
  ...
  private static final ComputableDataKey<LastTick> LAST_TICK = dev.tocraft.thconstruct.ThConstruct.createKey("last_tick", LastTick::new);

  /** Implements {@link dev.tocraft.thconstruct.library.modifiers.hook.interaction.BlockInteractionModifierHook} for weapons with left click */
  @SubscribeEvent
