...
public class ModifierEvents {
  ...
  private static final TinkerDataKey<Float> PROJECTILE_EXPERIENCE = dev.tocraft.thconstruct.ThConstruct.createKey("projectile_experience");
  /** Volatile data flag making a modifier grant the tool soulbound */
  public static final ResourceLocation SOULBOUND = dev.tocraft.thconstruct.ThConstruct.getResource("soulbound");
