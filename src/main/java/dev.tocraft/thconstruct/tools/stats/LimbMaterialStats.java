...
public record LimbMaterialStats(int durability, float drawSpeed, float velocity, float accuracy) implements IRepairableMaterialStats {
  public static final MaterialStatsId ID = new MaterialStatsId(dev.tocraft.thconstruct.ThConstruct.getResource("limb"));
  ...
  static final String ACCURACY_PREFIX = IMaterialStats.makeTooltipKey(dev.tocraft.thconstruct.ThConstruct.getResource("accuracy"));
  static final String DRAW_SPEED_PREFIX = IMaterialStats.makeTooltipKey(dev.tocraft.thconstruct.ThConstruct.getResource("draw_speed"));
  static final String VELOCITY_PREFIX = IMaterialStats.makeTooltipKey(dev.tocraft.thconstruct.ThConstruct.getResource("velocity"));
