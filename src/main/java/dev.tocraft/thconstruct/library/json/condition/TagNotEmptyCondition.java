package dev.tocraft.thconstruct.library.json.condition;
 ...
 * TODO: the non-loot condition form is redundant to {@link dev.tocraft.eomantle.recipe.helper.TagEmptyCondition}
 */
@RequiredArgsConstructor
public class TagNotEmptyCondition<T> implements LootItemCondition, ICondition {
  private static final ResourceLocation NAME = dev.tocraft.thconstruct.ThConstruct.getResource("tag_not_empty");
