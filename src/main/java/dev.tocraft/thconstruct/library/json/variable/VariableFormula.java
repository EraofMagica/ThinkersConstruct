package dev.tocraft.thconstruct.library.json.variable;
...
import dev.tocraft.thconstruct.library.json.math.StackOperation;

import java.util.LinkedHashMap;
import java.util.List;
import java.util.Map;

import static dev.tocraft.thconstruct.library.json.math.ModifierFormula.BASE_VALUE;
