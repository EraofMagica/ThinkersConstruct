...
public class Util {
  ...
  public static Logger getLogger(String type) {
    return LogManager.getLogger(dev.tocraft.thconstruct.ThConstruct.MOD_ID + "-" + type);
  }
  ...
  public static Optional<String> getCurrentlyActiveExternalMod() {
    return Optional.ofNullable(ModLoadingContext.get().getActiveContainer().getModId())
      .filter(activeModId -> !dev.tocraft.thconstruct.ThConstruct.MOD_ID.equals(activeModId));
  }
  ...
  public static Direction directionFromOffset(BlockPos pos, BlockPos neighbor) {
    ...
    dev.tocraft.thconstruct.ThConstruct.LOG.error("No direction for position {} and neighbor {}", pos, neighbor);
