package dev.tocraft.thconstruct.library.tools.part;
...
public class ToolPartItem extends MaterialItem implements IToolPart {
  private static final Component MISSING_INFO = dev.tocraft.thconstruct.ThConstruct.makeTranslation("tooltip", "part.missing_info");
  private static final String MISSING_MATERIAL_KEY = dev.tocraft.thconstruct.ThConstruct.makeTranslationKey("tooltip", "part.missing_material");
  private static final String MISSING_STATS_KEY = dev.tocraft.thconstruct.ThConstruct.makeTranslationKey("tooltip", "part.missing_stats");
  public static final String MATERIAL_KEY = dev.tocraft.thconstruct.ThConstruct.makeTranslationKey("tooltip", "part.material_id");
