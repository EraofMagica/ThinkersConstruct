...
public class TooltipBuilder {
  ...
  private static final Component TOOLTIP_BROKEN = dev.tocraft.thconstruct.ThConstruct.makeTranslation("tooltip", "tool.broken").withStyle(ChatFormatting.BOLD, ChatFormatting.DARK_RED);
