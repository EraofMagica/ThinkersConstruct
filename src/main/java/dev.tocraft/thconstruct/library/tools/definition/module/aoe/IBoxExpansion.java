package dev.tocraft.thconstruct.library.tools.definition.module.aoe;
...
public interface IBoxExpansion {
  ...
  IBoxExpansion SIDE_HIT = REGISTRY.register(dev.tocraft.thconstruct.ThConstruct.getResource("side_hit"), (player, sideHit) -> {
  ...
  IBoxExpansion PITCH = REGISTRY.register(dev.tocraft.thconstruct.ThConstruct.getResource("pitch"), (player, sideHit) -> {
    // depth is always direction into the block
  ...
  IBoxExpansion HEIGHT = REGISTRY.register(dev.tocraft.thconstruct.ThConstruct.getResource("height"), (player, sideHit) -> {
