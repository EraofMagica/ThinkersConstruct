...
import dev.tocraft.thconstruct.library.tools.definition.module.interaction.InteractionToolModule;
import dev.tocraft.thconstruct.library.tools.definition.module.material.MaterialRepairToolHook;
import dev.tocraft.thconstruct.library.tools.definition.module.material.MaterialRepairToolHook.MaxMerger;
import dev.tocraft.thconstruct.library.tools.definition.module.material.MissingMaterialsToolHook;
...
import dev.tocraft.thconstruct.library.tools.definition.module.mining.MiningTierToolHook;
...
public class ToolHooks {
  ...
  /** Registers a new tool hook under {@code thconstruct} that merges */
  ...
  /** Registers a new tool hook under {@code thconstruct} that cannot merge */
