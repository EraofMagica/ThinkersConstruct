...
import dev.tocraft.thconstruct.library.tools.capability.ToolCapabilityProvider.IToolCapabilityProvider;
...
public class ToolInventoryCapability extends InventoryModifierHookIterator<ModifierEntry> implements IItemHandlerModifiable {
  ...
  public static final ResourceLocation TOTAL_SLOTS = dev.tocraft.thconstruct.ThConstruct.getResource("total_item_slots");
  /** Boolean key to set in volatile mod data to enable the fluid capability */
  public static final ResourceLocation INCLUDE_OFFHAND = dev.tocraft.thconstruct.ThConstruct.getResource("inventory_show_offhand");

  /** Modifier hook instance to make an inventory modifier */
  public static final ModuleHook<InventoryModifierHook> HOOK = ModifierHooks.register(dev.tocraft.thconstruct.ThConstruct.getResource("inventory"), InventoryModifierHook.class, InventoryModifierHookMerger::new, new InventoryModifierHook() {
    @Override
