...
public class StationSlotLayout {
  private static final ResourceLocation EMPTY_NAME = dev.tocraft.thconstruct.ThConstruct.getResource("empty");
  ...
  public static class Builder {
    private static final Pattern PICKAXE = new Pattern(dev.tocraft.thconstruct.ThConstruct.MOD_ID, "pickaxe");
