package dev.tocraft.thconstruct.library.tools;
...
public final class SlotType {
  ...
  private static final String KEY_PREFIX = dev.tocraft.thconstruct.ThConstruct.makeTranslationKey("stat", "slot.prefix.");
  /** Key for lowercase slot name */
  public static final String KEY_DISPLAY = dev.tocraft.thconstruct.ThConstruct.makeTranslationKey("stat", "slot.display.");
   ...
   * Note that you will also want to define a texture for the creative modifier and JEI using {@link dev.tocraft.eomantle.client.model.NBTKeyModel#registerExtraTexture(ResourceLocation, String, ResourceLocation)}
