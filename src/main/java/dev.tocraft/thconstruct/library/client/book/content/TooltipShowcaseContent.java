...
import dev.tocraft.eomantle.client.book.data.content.ContentShowcase;
...
public class TooltipShowcaseContent extends ContentShowcase {
  public static final transient ResourceLocation ID = dev.tocraft.thconstruct.ThConstruct.getResource("showcase");
