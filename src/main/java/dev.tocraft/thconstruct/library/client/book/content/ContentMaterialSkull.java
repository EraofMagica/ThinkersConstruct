...
public class ContentMaterialSkull extends AbstractMaterialContent {
  ...
  private static final String SKULL_FROM = dev.tocraft.thconstruct.ThConstruct.makeTranslationKey("book", "material.skull_from");
  /** Page ID for using this index directly */
  public static final ResourceLocation ID = dev.tocraft.thconstruct.ThConstruct.getResource("skull_material");
