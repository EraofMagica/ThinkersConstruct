package dev.tocraft.thconstruct.library.client.book.elements;
...
import dev.tocraft.eomantle.client.screen.book.element.ArrowElement;
...
public class CycleRecipeElement extends ArrowElement {
  ...
  public void drawOverlay(PoseStack matrixStack, int mouseX, int mouseY, float partialTicks, Font fontRenderer) {
    if (this.isHovered(mouseX, mouseY)) {
      this.drawTooltip(matrixStack, Collections.singletonList(Component.translatable("gui.thconstruct.manual.cycle.recipes")), mouseX, mouseY, fontRenderer);
    }
  }
}
