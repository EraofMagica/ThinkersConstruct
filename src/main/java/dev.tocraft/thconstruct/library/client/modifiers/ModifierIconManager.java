...
public class ModifierIconManager implements IEarlySafeManagerReloadListener {
  ...
  private static final ResourceLocation DEFAULT_PAGES = dev.tocraft.thconstruct.ThConstruct.getResource("gui/modifiers/default_pages");
  /** Second layer of the default icon, will be tinted */
  private static final ResourceLocation DEFAULT_COVER = dev.tocraft.thconstruct.ThConstruct.getResource("gui/modifiers/default_cover");
