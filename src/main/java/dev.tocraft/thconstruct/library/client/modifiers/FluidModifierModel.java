...
import dev.tocraft.thconstruct.library.client.model.FluidContainerModel;
...
public class FluidModifierModel extends NormalModifierModel {
  ...
  private static final ResourceLocation BAKE_LOCATION = dev.tocraft.thconstruct.ThConstruct.getResource("dynamic_fluid_model");
