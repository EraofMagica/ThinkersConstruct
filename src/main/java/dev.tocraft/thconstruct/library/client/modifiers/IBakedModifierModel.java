package dev.tocraft.thconstruct.library.client.modifiers;
...
public interface IBakedModifierModel {
   ...
   * @param pixels           Item layer pixels to reduce z-fighting. Pass into methods from {@link dev.tocraft.eomantle.client.model.util.MantleItemLayerModel}
   */
  ...
  /**
   * Gets the color to tint this model. In general its better to use {@link dev.tocraft.eomantle.client.model.util.MantleItemLayerModel} as a baked color will be faster. Only use if you need dynamic colors
