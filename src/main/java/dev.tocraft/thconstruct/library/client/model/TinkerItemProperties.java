package dev.tocraft.thconstruct.library.client.model;
...
public class TinkerItemProperties {
  ...
  private static final ResourceLocation BROKEN_ID = dev.tocraft.thconstruct.ThConstruct.getResource("broken");
  ...
  private static final ResourceLocation AMMO_ID = dev.tocraft.thconstruct.ThConstruct.getResource("ammo");
  ...
  private static final ResourceLocation CHARGING_ID = dev.tocraft.thconstruct.ThConstruct.getResource("charging");
  ...
  private static final ResourceLocation CHARGE_ID = dev.tocraft.thconstruct.ThConstruct.getResource("charge");
