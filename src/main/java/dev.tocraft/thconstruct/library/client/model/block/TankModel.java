...
import dev.tocraft.eomantle.client.model.util.ExtraTextureContext;
...
public class TankModel implements IUnbakedGeometry<TankModel> {
  protected static final ResourceLocation BAKE_LOCATION = dev.tocraft.thconstruct.ThConstruct.getResource("dynamic_model_baking");
  ...
  public static class Baked<T extends TankModel> extends BakedUniqueGuiModel {
    ...
    private BakedModel getCachedModel(FluidStack fluid) {
      try {
        ...
        dev.tocraft.thconstruct.ThConstruct.LOG.error(e);
        return this;
      }
    }
