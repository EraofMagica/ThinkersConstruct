package dev.tocraft.thconstruct.library.client.model.block;
...
import dev.tocraft.eomantle.client.model.RetexturedModel;
import dev.tocraft.eomantle.client.model.RetexturedModel.RetexturedContext;
import dev.tocraft.eomantle.client.model.util.ColoredBlockModel;
import dev.tocraft.eomantle.client.model.util.ColoredBlockModel.ColorData;
import dev.tocraft.eomantle.client.model.util.DynamicBakedWrapper;
      ...
      for (int i = 0; i < size; i++) {
        ...
        if (fluidFaces > 0) {
          if (fluidFaces < part.faces.size()) {
            dev.tocraft.thconstruct.ThConstruct.LOG.warn("Mixed fluid and non-fluid elements in model {}, may cause unexpected results", modelLocation);
          }
          fluidParts.set(i);
        }
      }
