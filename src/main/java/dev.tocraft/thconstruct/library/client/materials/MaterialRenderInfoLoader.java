package dev.tocraft.thconstruct.library.client.materials;
...
import dev.tocraft.eomantle.data.gson.ResourceLocationSerializer;
import dev.tocraft.eomantle.data.listener.IEarlySafeManagerReloadListener;
 ...
 * See {@link dev.tocraft.thconstruct.library.materials.stats.MaterialStatsManager} for stats.
 * <p>
...
public class MaterialRenderInfoLoader implements IEarlySafeManagerReloadListener {
  ...
  public static final Gson GSON = (new GsonBuilder())
    ...
    .registerTypeAdapter(MaterialStatsId.class, new ResourceLocationSerializer<>(MaterialStatsId::new, dev.tocraft.thconstruct.ThConstruct.MOD_ID))
