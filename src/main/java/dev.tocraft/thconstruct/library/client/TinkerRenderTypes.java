package dev.tocraft.thconstruct.library.client;
...
public class TinkerRenderTypes extends RenderType {
  ...
  public static final RenderType ERROR_BLOCK = RenderType.create(
    dev.tocraft.thconstruct.ThConstruct.resourceString("lines"), DefaultVertexFormat.POSITION_COLOR_NORMAL, VertexFormat.Mode.LINES, 256, false, false,
  ...
  /** Render type for fluids, like {@link dev.tocraft.eomantle.client.render.MantleRenderTypes#FLUID}, but disables cull so both sides show */
  public static final RenderType SMELTERY_FLUID = RenderType.create(
    dev.tocraft.thconstruct.ThConstruct.resourceString("smeltery_fluid"), DefaultVertexFormat.POSITION_COLOR_TEX_LIGHTMAP, VertexFormat.Mode.QUADS, 256, false, true,
