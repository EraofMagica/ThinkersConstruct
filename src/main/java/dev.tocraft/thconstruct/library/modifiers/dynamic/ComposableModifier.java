...
import dev.tocraft.thconstruct.library.modifiers.impl.BasicModifier;
    ...
    if (!priorityModules.isEmpty()) {
      ...
      for (int i = 1; i < priorityModules.size(); i++) {
        ...
        if (priorityModules.get(i).getPriority() != firstPriority) {
          dev.tocraft.thconstruct.ThConstruct.LOG.warn("Multiple modules disagree on the preferred priority for composable modifier, choosing priority {}. Set the priority manually to silence this warning. All opinions: \n{}", firstPriority,
