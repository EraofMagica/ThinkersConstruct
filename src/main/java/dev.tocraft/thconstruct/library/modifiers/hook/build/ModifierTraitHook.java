package dev.tocraft.thconstruct.library.modifiers.hook.build;
    ...
    private void addTraits(ModifierEntry entry) {
      ...
      if (hook != null) {
        ...
        if (currentStack.contains(modifier)) {
          dev.tocraft.thconstruct.ThConstruct.LOG.error("Encountered {} as a child of itself, previous stack {}", modifier.getId(), currentStack);
        } else {
