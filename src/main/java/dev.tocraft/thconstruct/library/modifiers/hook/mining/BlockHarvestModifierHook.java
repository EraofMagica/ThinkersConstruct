package dev.tocraft.thconstruct.library.modifiers.hook.mining;
...
public interface BlockHarvestModifierHook {
  /**
   * Called when a tool is about to break blocks to allow setting markers on the tool for hooks with less context (such as {@link dev.tocraft.thconstruct.library.modifiers.hook.behavior.EnchantmentModifierHook}).
   ...
   * @see dev.tocraft.thconstruct.library.modifiers.modules.technical.MarkHarvestingModule
   */
  interface MarkHarvesting extends BlockHarvestModifierHook {
    ...
    ResourceLocation HARVESTING_FLAG = dev.tocraft.thconstruct.ThConstruct.getResource("is_harvesting");
