package dev.tocraft.thconstruct.library.modifiers.hook.combat;
...
public interface MeleeDamageModifierHook {
   ...
   * Alternatives:
   * <ul>
   *   <li>{@link dev.tocraft.thconstruct.library.modifiers.hook.build.ToolStatsModifierHook}: Adjusts the base tool stats that show in the tooltip, but has less context for modification</li>
