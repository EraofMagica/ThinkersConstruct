 ...
 * In most cases it's better to use {@link dev.tocraft.thconstruct.library.modifiers.dynamic.ComposableModifier},
...
public class BasicModifier extends Modifier {
  ...
  /**
   * Builder to create simple static modifiers. Similar to {@link dev.tocraft.thconstruct.library.modifiers.dynamic.ComposableModifier.Builder}, except more efficient as we don't require it be JSON serializable.
