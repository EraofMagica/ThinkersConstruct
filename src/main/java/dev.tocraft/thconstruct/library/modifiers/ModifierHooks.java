...
import dev.tocraft.eomantle.data.registry.IdAwareComponentRegistry;
...
import dev.tocraft.thconstruct.library.modifiers.hook.armor.ElytraFlightModifierHook;
...
import dev.tocraft.thconstruct.library.modifiers.hook.behavior.AttributesModifierHook;
import dev.tocraft.thconstruct.library.modifiers.hook.behavior.EnchantmentModifierHook;
...
import dev.tocraft.thconstruct.library.modifiers.hook.display.RequirementsModifierHook;
...
import dev.tocraft.thconstruct.library.modifiers.hook.mining.HarvestEnchantmentsModifierHook;
import dev.tocraft.thconstruct.library.modifiers.hook.mining.RemoveBlockModifierHook;
...
import dev.tocraft.thconstruct.library.modifiers.hook.special.BlockTransformModifierHook;
import dev.tocraft.thconstruct.library.modifiers.hook.special.PlantHarvestModifierHook;
import dev.tocraft.thconstruct.library.modifiers.hook.special.ShearsModifierHook;
...
public class ModifierHooks {
  ...
  /** Registers a new modifier hook under {@code thconstruct} */
  private static <T> ModuleHook<T> register(String name, Class<T> filter, @Nullable Function<Collection<T>,T> merger, T defaultInstance) {
    return register(dev.tocraft.thconstruct.ThConstruct.getResource(name), filter, merger, defaultInstance);
  }

  /** Registers a new modifier hook under {@code thconstruct}  that cannot merge */
