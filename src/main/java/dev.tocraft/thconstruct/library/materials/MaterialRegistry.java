...
import dev.tocraft.eomantle.network.packet.ISimplePacket;
import dev.tocraft.thconstruct.common.network.TinkerNetwork;
import dev.tocraft.thconstruct.library.events.MaterialsLoadedEvent;
...
public final class MaterialRegistry {
  ...
  public static final MaterialStatsId MELEE_HARVEST = new MaterialStatsId(dev.tocraft.thconstruct.ThConstruct.getResource("melee_harvest"));
  /** Internal material stats ID for the sake of adding traits exclusive to ranged materials */
  public static final MaterialStatsId RANGED = new MaterialStatsId(dev.tocraft.thconstruct.ThConstruct.getResource("ranged"));
  /** Internal material stats ID for the sake of adding traits exclusive to armor materials */
  public static final MaterialStatsId ARMOR = new MaterialStatsId(dev.tocraft.thconstruct.ThConstruct.getResource("armor"));
