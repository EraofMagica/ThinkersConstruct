...
public interface IMaterialRegistry {
  ...
  /**
   * Checks if the given material stats ID can repair, this is equivelent to an instanceof check on a stat type for {@link dev.tocraft.thconstruct.library.materials.stats.IRepairableMaterialStats}
