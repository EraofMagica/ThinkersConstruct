  ...
  public void run(CachedOutput cache) throws IOException {
    ...
    this.builders.forEach((id, builder) -> {
      ...
      if (!invalidEntries.isEmpty()) {
        ...
        saveJson(cache, id, TagFile.CODEC.encodeStart(JsonOps.INSTANCE, new TagFile(tagEntries, false)).getOrThrow(false, dev.tocraft.thconstruct.ThConstruct.LOG::error));
      }
    });
  }
