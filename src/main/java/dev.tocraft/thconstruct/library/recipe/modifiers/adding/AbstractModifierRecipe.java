...
public abstract class AbstractModifierRecipe implements ITinkerStationRecipe, IDisplayModifierRecipe {
  ...
  protected static final String KEY_MIN_LEVEL = dev.tocraft.thconstruct.ThConstruct.makeTranslationKey("recipe", "modifier.min_level");
  ...
  protected static final String KEY_MAX_LEVEL = dev.tocraft.thconstruct.ThConstruct.makeTranslationKey("recipe", "modifier.max_level");
  protected static final String KEY_MAX_LEVEL_TRAITS = KEY_MAX_LEVEL + ".traits";
  /** Error for when the tool has too few upgrade slots */
  protected static final String KEY_NOT_ENOUGH_SLOTS = dev.tocraft.thconstruct.ThConstruct.makeTranslationKey("recipe", "modifier.not_enough_slots");
  /** Error for when the tool has too few upgrade slots from a single slot */
  protected static final String KEY_NOT_ENOUGH_SLOT = dev.tocraft.thconstruct.ThConstruct.makeTranslationKey("recipe", "modifier.not_enough_slot");
