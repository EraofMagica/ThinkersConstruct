package dev.tocraft.thconstruct.library.recipe.ingredient;
...
public class NoContainerIngredient extends NestedIngredient {
  public static final ResourceLocation ID = dev.tocraft.thconstruct.ThConstruct.getResource("no_container");
