package dev.tocraft.thconstruct.library.recipe.melting;
...
import dev.tocraft.thconstruct.common.config.Config.OreRate;
import dev.tocraft.thconstruct.library.json.TinkerLoadables;
import dev.tocraft.thconstruct.library.json.field.MergingListField;
