...
public class MaterialFluidRecipe implements ICustomOutputRecipe<ICastingContainer> {
  ...
  public static final MaterialFluidRecipe EMPTY = new MaterialFluidRecipe(dev.tocraft.thconstruct.ThConstruct.getResource("missingno"), FluidIngredient.EMPTY, 0, null, IMaterial.UNKNOWN_ID);
