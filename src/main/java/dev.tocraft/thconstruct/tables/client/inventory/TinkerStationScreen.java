...
import dev.tocraft.eomantle.client.screen.ModuleScreen;
...
import dev.tocraft.thconstruct.library.tools.item.ITinkerStationDisplay;
import dev.tocraft.thconstruct.library.tools.layout.LayoutIcon;
import dev.tocraft.thconstruct.library.tools.layout.LayoutSlot;
import dev.tocraft.thconstruct.library.tools.layout.StationSlotLayout;
...
import dev.tocraft.thconstruct.library.utils.TinkerTooltipFlags;
import dev.tocraft.thconstruct.tables.block.entity.table.TinkerStationBlockEntity;
import dev.tocraft.thconstruct.tables.client.inventory.module.InfoPanelScreen;
import dev.tocraft.thconstruct.tables.client.inventory.widget.SlotButtonItem;
import dev.tocraft.thconstruct.tables.client.inventory.widget.TinkerStationButtonsWidget;
import dev.tocraft.thconstruct.tables.menu.TinkerStationContainerMenu;
import dev.tocraft.thconstruct.tables.menu.slot.TinkerStationSlot;
...
import static dev.tocraft.thconstruct.tables.block.entity.table.TinkerStationBlockEntity.INPUT_SLOT;
import static dev.tocraft.thconstruct.tables.block.entity.table.TinkerStationBlockEntity.TINKER_SLOT;

public class TinkerStationScreen extends BaseTabbedScreen<TinkerStationBlockEntity,TinkerStationContainerMenu> {
  // titles to display
  private static final Component COMPONENTS_TEXT = dev.tocraft.thconstruct.ThConstruct.makeTranslation("gui", "tinker_station.components");
  private static final Component MODIFIERS_TEXT = dev.tocraft.thconstruct.ThConstruct.makeTranslation("gui", "tinker_station.modifiers");
  private static final Component UPGRADES_TEXT = dev.tocraft.thconstruct.ThConstruct.makeTranslation("gui", "tinker_station.upgrades");
  private static final Component TRAITS_TEXT = dev.tocraft.thconstruct.ThConstruct.makeTranslation("gui", "tinker_station.traits");
  ...
  // texture
  private static final ResourceLocation TINKER_STATION_TEXTURE = dev.tocraft.thconstruct.ThConstruct.getResource("textures/gui/tinker_station.png");
  // texture elements
