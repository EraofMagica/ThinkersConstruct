...
public class PartInfoPanelScreen extends InfoPanelScreen {
  private static final String COST_KEY = dev.tocraft.thconstruct.ThConstruct.makeTranslationKey("gui", "part_builder.cost");
  private static final String MATERIAL_VALUE_KEY = dev.tocraft.thconstruct.ThConstruct.makeTranslationKey("gui", "part_builder.material_value");
