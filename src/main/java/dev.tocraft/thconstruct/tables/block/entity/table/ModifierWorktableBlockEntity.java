...
import dev.tocraft.thconstruct.tables.block.entity.inventory.ModifierWorktableContainerWrapper;
...
public class ModifierWorktableBlockEntity extends RetexturedTableBlockEntity implements ILazyCrafter {
  ...
  /** Title for the GUI */
  private static final Component NAME = dev.tocraft.thconstruct.ThConstruct.makeTranslation("gui", "modifier_worktable");
