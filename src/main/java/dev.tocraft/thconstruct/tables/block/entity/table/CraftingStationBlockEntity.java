package dev.tocraft.thconstruct.tables.block.entity.table;
...
import dev.tocraft.thconstruct.shared.inventory.ConfigurableInvWrapperCapability;
import dev.tocraft.thconstruct.tables.TinkerTables;
import dev.tocraft.thconstruct.tables.block.entity.inventory.CraftingContainerWrapper;
import dev.tocraft.thconstruct.tables.block.entity.inventory.LazyResultContainer;
import dev.tocraft.thconstruct.tables.block.entity.inventory.LazyResultContainer.ILazyCrafter;
...
public class CraftingStationBlockEntity extends RetexturedTableBlockEntity implements ILazyCrafter {
  public static final Component UNCRAFTABLE = dev.tocraft.thconstruct.ThConstruct.makeTranslation("gui", "crafting_station.uncraftable");
  private static final Component NAME = dev.tocraft.thconstruct.ThConstruct.makeTranslation("gui", "crafting_station");
