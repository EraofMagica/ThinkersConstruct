...
public class TinkerStationRepairRecipe implements ITinkerStationRecipe {
  protected static final RecipeResult<ItemStack> FULLY_REPAIRED = RecipeResult.failure(dev.tocraft.thconstruct.ThConstruct.makeTranslationKey("recipe", "tool_repair.fully_repaired"));
  ...
  public void updateInputs(ItemStack result, IMutableTinkerStationContainer inv, boolean isServer) {
    ...
    if (repairRemaining > 0) {
      dev.tocraft.thconstruct.ThConstruct.LOG.error("Recipe repair on {} consumed too few items. {} durability unaccounted for", result, repairRemaining);
    }
  }
