...
import dev.tocraft.thconstruct.library.recipe.partbuilder.ItemPartRecipe;
import dev.tocraft.thconstruct.library.recipe.partbuilder.PartRecipe;
import dev.tocraft.thconstruct.library.recipe.tinkerstation.building.ToolBuildingRecipe;
import dev.tocraft.thconstruct.library.tools.layout.StationSlotLayoutLoader;
import dev.tocraft.thconstruct.shared.block.TableBlock;
import dev.tocraft.thconstruct.tables.block.ChestBlock;
import dev.tocraft.thconstruct.tables.block.CraftingStationBlock;
import dev.tocraft.thconstruct.tables.block.GenericTableBlock;
import dev.tocraft.thconstruct.tables.block.ScorchedAnvilBlock;
import dev.tocraft.thconstruct.tables.block.TinkerStationBlock;
import dev.tocraft.thconstruct.tables.block.TinkersAnvilBlock;
import dev.tocraft.thconstruct.tables.block.TinkersChestBlock;
import dev.tocraft.thconstruct.tables.block.entity.chest.CastChestBlockEntity;
import dev.tocraft.thconstruct.tables.block.entity.chest.PartChestBlockEntity;
...
import dev.tocraft.thconstruct.tables.block.entity.table.ModifierWorktableBlockEntity;
import dev.tocraft.thconstruct.tables.block.entity.table.PartBuilderBlockEntity;
import dev.tocraft.thconstruct.tables.block.entity.table.TinkerStationBlockEntity;
import dev.tocraft.thconstruct.tables.data.TableRecipeProvider;
import dev.tocraft.thconstruct.tables.item.TableBlockItem;
import dev.tocraft.thconstruct.tables.item.TinkersChestBlockItem;
import dev.tocraft.thconstruct.tables.menu.CraftingStationContainerMenu;
import dev.tocraft.thconstruct.tables.menu.ModifierWorktableContainerMenu;
import dev.tocraft.thconstruct.tables.menu.PartBuilderContainerMenu;
import dev.tocraft.thconstruct.tables.menu.TinkerChestContainerMenu;
...
import dev.tocraft.thconstruct.tables.recipe.PartBuilderToolRecycle;
import dev.tocraft.thconstruct.tables.recipe.TinkerStationDamagingRecipe;
import dev.tocraft.thconstruct.tables.recipe.TinkerStationPartSwapping;
