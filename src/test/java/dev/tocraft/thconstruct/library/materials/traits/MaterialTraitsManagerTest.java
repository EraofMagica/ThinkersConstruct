package dev.tocraft.thconstruct.library.materials.traits;
...
class MaterialTraitsManagerTest extends BaseMcTest {
  ...
  private static final MaterialId DEFAULT_TRAITS = new MaterialId(dev.tocraft.thconstruct.ThConstruct.getResource("default"));
  // file containing just traits per stat type
  private static final MaterialId PER_STAT_TRAITS = new MaterialId(dev.tocraft.thconstruct.ThConstruct.getResource("per_stat"));
  // file containing both, and lists
  private static final MaterialId MULTIPLE_TRAITS = new MaterialId(dev.tocraft.thconstruct.ThConstruct.getResource("multiple"));
  ...
  @Test
  void empty() {
    MaterialId empty = new MaterialId(dev.tocraft.thconstruct.ThConstruct.getResource("empty"));
