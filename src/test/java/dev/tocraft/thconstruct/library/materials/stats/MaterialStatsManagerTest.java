...
import dev.tocraft.eomantle.data.listener.MergingJsonFileLoader;
...
class MaterialStatsManagerTest extends BaseMcTest {
  ...
  void testLoadFile_statsExist() {
    ...
    MaterialId material = new MaterialId(dev.tocraft.thconstruct.ThConstruct.getResource("teststat"));
  ...
  void testLoadFile_multipleStatsInOneFile() {
    MaterialId material = new MaterialId(dev.tocraft.thconstruct.ThConstruct.getResource("multiple"));
  ...
  void testLoadFileWithEmptyStats_ok() {
    MaterialId material = new MaterialId(dev.tocraft.thconstruct.ThConstruct.getResource("empty"));
    fileLoader.loadAndParseFiles(null, material);
  ...
  void testLoadFileWithoutStats_ok() {
    MaterialId material = new MaterialId(dev.tocraft.thconstruct.ThConstruct.getResource("missing_stats"));
    fileLoader.loadAndParseFiles(null, material);
  ...
  void loadMissingFile_ignored() {
    MaterialId material = new MaterialId(dev.tocraft.thconstruct.ThConstruct.getResource("nonexistant"));
  ...
  void loadFileWithOnlyUnregisteredStats_doNothing() {
    MaterialId material = new MaterialId(dev.tocraft.thconstruct.ThConstruct.getResource("invalid"));
    fileLoader.loadAndParseFiles(null, material);
