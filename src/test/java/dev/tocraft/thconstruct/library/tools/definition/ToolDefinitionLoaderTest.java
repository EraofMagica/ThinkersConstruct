...
class ToolDefinitionLoaderTest extends BaseMcTest {
  ...
  private static final ToolDefinition NO_PARTS_MINIMAL = ToolDefinition.create(dev.tocraft.thconstruct.ThConstruct.getResource("minimal_no_parts"));
  private static final ToolDefinition NO_PARTS_FULL = ToolDefinition.create(dev.tocraft.thconstruct.ThConstruct.getResource("full_no_parts"));
  private static final ToolDefinition MELEE_HARVEST_MINIMAL = ToolDefinition.create(dev.tocraft.thconstruct.ThConstruct.getResource("minimal_with_parts"));
  private static final ToolDefinition MELEE_HARVEST_FULL = ToolDefinition.create(dev.tocraft.thconstruct.ThConstruct.getResource("full_with_parts"));
  private static final ToolDefinition NEED_PARTS_HAS_NONE = ToolDefinition.create(dev.tocraft.thconstruct.ThConstruct.getResource("need_parts_has_none"));
  private static final ToolDefinition WRONG_PART_TYPE = ToolDefinition.create(dev.tocraft.thconstruct.ThConstruct.getResource("wrong_part_type"));
