package dev.tocraft.thconstruct.library.tools.layout;
...
import dev.tocraft.thconstruct.test.JsonFileLoader;
...
class StationSlotLayoutLoaderTest extends BaseMcTest {
  ...
  void minimal_noTool() {
    ...
    StationSlotLayout layout = StationSlotLayoutLoader.getInstance().get(dev.tocraft.thconstruct.ThConstruct.getResource("minimal"));
    assertThat(layout.getName().toString()).isEqualTo("thconstruct:minimal");
  ...
  void minimal_withTool() {
    ...
    StationSlotLayout layout = StationSlotLayoutLoader.getInstance().get(dev.tocraft.thconstruct.ThConstruct.getResource("minimal_with_tool"));
    assertThat(layout.getName().toString()).isEqualTo("thconstruct:minimal_with_tool");
    assertThat(layout.getTranslationKey()).isEmpty();
    assertThat(layout.getIcon()).isSameAs(LayoutIcon.EMPTY);
    assertThat(layout.getSortIndex()).isEqualTo(255);
    // slots
  ...
  void full() {
    ...
    StationSlotLayout layout = StationSlotLayoutLoader.getInstance().get(dev.tocraft.thconstruct.ThConstruct.getResource("full"));
    assertThat(layout.getName().toString()).isEqualTo("thconstruct:full");
  ...
  void missing_defaults() {
    ...
    StationSlotLayout layout = StationSlotLayoutLoader.getInstance().get(dev.tocraft.thconstruct.ThConstruct.getResource("missing"));
  ...
  void tooFewSlots_defaults() {
    ...
    StationSlotLayoutLoader.getInstance().apply(splashList, mock(ResourceManager.class), mock(ProfilerFiller.class));
    StationSlotLayout layout = StationSlotLayoutLoader.getInstance().get(dev.tocraft.thconstruct.ThConstruct.getResource("too_few_slots"));
    assertThat(layout).isSameAs(StationSlotLayout.EMPTY);
  }
  ...
  void tooFewSlots_withTool_defaults() {
    ...
    StationSlotLayoutLoader.getInstance().apply(splashList, mock(ResourceManager.class), mock(ProfilerFiller.class));
    StationSlotLayout layout = StationSlotLayoutLoader.getInstance().get(dev.tocraft.thconstruct.ThConstruct.getResource("too_few_slots_with_tool"));
    assertThat(layout).isSameAs(StationSlotLayout.EMPTY);
  }
}
